...
- `suspended` — deliberately deferred; do not pick up unless explicitly re-instated to `pending`
...
| 28 | [use-cases/28-bundle-ffprobe-and-verify-ffmpeg.md](use-cases/28-bundle-ffprobe-and-verify-ffmpeg.md) | Bundle ffprobe (and verify ffmpeg) for audio-only post-processing | in-progress | 2026-05-11 |
